...
export default function Lobbies({ lobbies: initialLobbies, currentLobby, props }: LobbiesProps) {
  const [loading, setLoading] = useState(false)
  const lobbyContext = useLobbyContext()
  const { user } = usePage().props as unknown as {
    user: { uuid: string; fullName: string | null; email: string; nickName: string } | null
  }
