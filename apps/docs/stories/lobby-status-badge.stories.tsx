...
export const BadgeGroupSizes: GroupStory = {
	render: () => (
		<div className="space-y-4">
			<div>
				<h3 className="text-sm font-medium mb-2">Small</h3>
				<LobbyBadgeGroup status="WAITING" isPrivate={false} currentPlayers={2} maxPlayers={4} size="sm" />
			</div>
			<div>
				<h3 className="text-sm font-medium mb-2">Medium</h3>
				<LobbyBadgeGroup status="READY" isPrivate={true} currentPlayers={3} maxPlayers={4} size="md" />
			</div>
			<div>
				<h3 className="text-sm font-medium mb-2">Large</h3>
				<LobbyBadgeGroup status="IN_GAME" isPrivate={false} currentPlayers={4} maxPlayers={4} size="lg" />
			</div>
		</div>
	),
};
...
export const BadgeGroupVariants: GroupStory = {
	render: () => (
		<div className="space-y-4">
			<div>
				<h3 className="text-sm font-medium mb-2">Default</h3>
				<LobbyBadgeGroup status="WAITING" isPrivate={false} currentPlayers={2} maxPlayers={4} variant="default" />
			</div>
			<div>
				<h3 className="text-sm font-medium mb-2">Outline</h3>
				<LobbyBadgeGroup status="READY" isPrivate={true} currentPlayers={3} maxPlayers={4} variant="outline" />
			</div>
			<div>
				<h3 className="text-sm font-medium mb-2">Secondary</h3>
				<LobbyBadgeGroup status="IN_GAME" isPrivate={false} currentPlayers={4} maxPlayers={4} variant="secondary" />
			</div>
		</div>
	),
};
