...
import { CheckCircle2, Clock, Crown, Globe, ShieldCheck, Star, Timer, Trash2, User, Zap } from 'lucide-react';
	...
	render: () => (
		<div className="flex flex-wrap gap-2">
			{[
				...
				<Badge key={link.href} variant={link.variant} asChild>
...
export const Notifications: Story = {
	render: () => (
		<div className="flex flex-wrap gap-4">
			...
			<div className="relative inline-flex">
				<Badge variant="neutral" className="absolute -top-2 -right-2 h-5 w-5 rounded-full p-0">
					9
				</Badge>
				<div className="h-10 w-10 rounded-full bg-secondary" />
			</div>
...
export const CustomStyles: Story = {
	render: () => (
		<div className="flex flex-wrap gap-2">
			<Badge className="bg-blue-500/10 text-blue-500 border-blue-500/20">Custom Blue</Badge>
			<Badge className="bg-green-500/10 text-green-500 border-green-500/20">Custom Green</Badge>
			<Badge className="bg-purple-500/10 text-purple-500 border-purple-500/20">Custom Purple</Badge>
			<Badge className="bg-orange-500/10 text-orange-500 border-orange-500/20">Custom Orange</Badge>
		</div>
	),
};
