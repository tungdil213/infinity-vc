...
import { ChartContainer, ChartTooltip, ChartTooltipContent } from '@infinity.dev/ui/primitives/chart';
import {
	Area,
	AreaChart,
	Bar,
			...
			<Card className="w-[800px] p-6">
				<div className="space-y-4">
					<div>
						...
						<p className="text-sm text-muted-foreground">Monthly sales and revenue data</p>
					</div>
			...
			<Card className="w-[800px] p-6">
				<div className="space-y-4">
					<div>
						...
						<p className="text-sm text-muted-foreground">Website visitors over 24 hours</p>
					</div>
					<ChartContainer config={config}>
						<AreaChart data={data}>
							<CartesianGrid strokeDasharray="3 3" />
			...
			<Card className="w-[800px] p-6">
				<div className="space-y-4">
					<div>
						...
						<p className="text-sm text-muted-foreground">Daily active users by platform</p>
					</div>
					<ChartContainer config={config}>
						<BarChart data={data}>
							<CartesianGrid strokeDasharray="3 3" />
			...
			<Card className="w-[400px] p-6">
				<div className="space-y-4">
					<div>
						...
						<p className="text-sm text-muted-foreground">Distribution of browser usage</p>
					</div>
					<ChartContainer config={config}>
						<PieChart>
