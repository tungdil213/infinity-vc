...
import { Laptop, Moon, Sun, CreditCard, Wallet, Smartphone, Inbox, Archive, Trash } from 'lucide-react';
				...
				<div className="grid gap-2">
					{[
						...
						<div key={item.value} className="flex items-center space-x-2 rounded-md border p-3">
							...
							<Label htmlFor={item.value} className="flex flex-1 items-center gap-2">
				...
				<div className="grid gap-2">
					{[
						...
						<Card key={item.value} className="relative">
							<RadioGroupItem value={item.value} id={item.value} className="absolute right-4 top-4" />
							<Label htmlFor={item.value} className="block cursor-pointer p-4">
			...
			<div className="grid gap-4">
				...
				<div className="grid gap-2">
					{[
						...
						<div key={item.value} className="flex items-center space-x-2 rounded-md border p-3">
							<RadioGroupItem value={item.value} id={item.value} />
							<Label htmlFor={item.value} className="flex flex-1 items-center justify-between">
