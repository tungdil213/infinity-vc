...
import { Menu, Settings, User, Mail, MessageSquare, PlusCircle, CreditCard, Bell, Github } from 'lucide-react';
					...
					<div className="grid gap-2">
						...
						<div className="grid gap-4">
							<div className="grid grid-cols-4 items-center gap-4">
								...
								<Input id="email" value="pedro@example.com" className="col-span-3" readOnly />
							</div>
							<div className="grid grid-cols-4 items-center gap-4">
								<Label htmlFor="username" className="text-right">
									Username
