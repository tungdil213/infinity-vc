...
export const Disabled: Story = {
	render: (args) => (
		<div className="grid gap-2">
			...
			<Textarea id="disabled" {...args} disabled placeholder="You cannot edit this textarea." />
		</div>
	),
};
...
export const WithRows: Story = {
	render: (args) => (
		<div className="grid gap-2">
			...
			<Textarea id="fixed-rows" {...args} rows={5} placeholder="This textarea has a fixed height of 5 rows." />
		</div>
	),
};
...
export const WithError: Story = {
	render: (args) => (
		<div className="grid gap-2">
			...
			<Textarea id="error" {...args} aria-invalid placeholder="This textarea has an error." />
		...
		return (
			<div className="grid gap-2">
				...
				<div className="grid gap-1">
					<Textarea id="with-counter" {...args} maxLength={maxLength} placeholder="Tell us about yourself..." />
	...
	render: (args) => (
		<div className="grid gap-4">
			<div className="grid gap-2">
				...
				<Textarea id="feedback" {...args} placeholder="Tell us what you think..." />
				<p className="text-sm text-muted-foreground">Your feedback will help us improve our product.</p>
			</div>
		</div>
	),
};
	...
	render: (args) => (
		<div className="grid gap-2">
			...
			<div className="grid gap-4">
				...
				<Textarea id="rich-text" {...args} placeholder="**Bold** and *italic* text is supported." rows={6} />
			</div>
		</div>
	),
};
