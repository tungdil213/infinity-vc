						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormDescription>Enter your email address to sign in</FormDescription>
									<FormMessage />
								</FormItem>
							)}
						/>
			...
			<Card className="w-[400px] p-6">
				<div className="space-y-4">
					<div>
						...
						<p className="text-sm text-muted-foreground">Get updates on topics that interest you</p>
					</div>
					<Form {...form}>
						<form onSubmit={form.handleSubmit(console.log)} className="space-y-4">
							<FormField
							...
							<div className="space-y-2">
								...
								{['Technology', 'Design', 'Business', 'Marketing'].map((interest) => (
									<FormField
										...
										name="interests"
										render={({ field }) => (
											<FormItem key={interest} className="flex flex-row items-center space-x-2 space-y-0">
												<FormControl>
													<Checkbox
