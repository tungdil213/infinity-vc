...
import { ToggleGroup, ToggleGroupItem } from '@infinity.dev/ui/primitives/toggle-group';
import {
	AlignLeft,
	AlignCenter,
	AlignRight,
...
export const CustomStyles: Story = {
	render: () => (
		<ToggleGroup type="single" className="bg-secondary p-1 [&>*]:rounded-sm" defaultValue="brush">
			<ToggleGroupItem
				value="brush"
