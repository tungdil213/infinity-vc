	...
	render: (args) => (
		<div className="space-y-2">
			<div className="flex items-center space-x-2">
				...
				<label htmlFor="error" className="text-sm font-medium leading-none text-destructive">
					Invalid checkbox
				</label>
			</div>
	...
	render: (args) => (
		<div className="space-y-4">
			<fieldset className="space-y-2">
				<legend className="text-sm font-medium leading-none">Select your favorite fruits</legend>
				<div className="space-y-2">
					<div className="flex items-center space-x-2">
...
export const FormField: Story = {
	render: (args) => (
		<div className="space-y-4">
			<fieldset className="space-y-2">
				<legend className="text-sm font-medium leading-none">Newsletter Preferences</legend>
				<div className="space-y-2">
					<div className="flex items-center space-x-2">
				...
				<p className="text-sm text-muted-foreground">You can change these preferences at any time.</p>
			</fieldset>
		</div>
	),
};
