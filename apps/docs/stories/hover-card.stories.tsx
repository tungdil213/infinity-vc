...
import { HoverCard, HoverCardContent, HoverCardTrigger } from '@infinity.dev/ui/primitives/hover-card';
			...
			<HoverCard>
				...
				<HoverCardContent side="top">
					<div className="flex flex-col gap-2">
						...
						<p className="text-sm text-muted-foreground">View our open source projects and contributions.</p>
					</div>
				</HoverCardContent>
			</HoverCard>
			<HoverCard>
				...
				<HoverCardContent side="top">
					<div className="flex flex-col gap-2">
						...
						<p className="text-sm text-muted-foreground">Follow us for updates and announcements.</p>
					</div>
				</HoverCardContent>
			</HoverCard>
		</div>
		...
		<HoverCard>
			...
			<HoverCardContent className="w-80 bg-gradient-to-br from-purple-500 to-pink-500 border-none">
				<div className="text-white">
					...
					<p className="text-sm opacity-90">This card has a gradient background and custom styling.</p>
				</div>
			</HoverCardContent>
		</HoverCard>
	),
