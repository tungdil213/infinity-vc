...
export const ToggleGroup: Story = {
	render: () => (
		<div className="space-y-4">
			<div className="flex items-center space-x-2">
				<Toggle variant="outline" className="rounded-r-none" aria-label="List view">
					<List className="h-4 w-4" />
				</Toggle>
				<Toggle variant="outline" className="rounded-none border-l-0" aria-label="Ordered list view">
					<ListOrdered className="h-4 w-4" />
				</Toggle>
				<Toggle variant="outline" className="rounded-l-none border-l-0" aria-label="Tree view">
					<ListTree className="h-4 w-4" />
				</Toggle>
			</div>
			<div className="flex items-center space-x-2">
				<Toggle variant="outline" className="rounded-r-none" aria-label="Align left">
					<AlignLeft className="h-4 w-4" />
				</Toggle>
				<Toggle variant="outline" className="rounded-none border-l-0" aria-label="Align center">
					<AlignCenter className="h-4 w-4" />
				</Toggle>
				<Toggle variant="outline" className="rounded-l-none border-l-0" aria-label="Align right">
					<AlignRight className="h-4 w-4" />
				</Toggle>
			</div>
		</div>
...
export const CustomStyles: Story = {
	render: () => (
		<div className="flex items-center space-x-2">
			<Toggle className="bg-blue-100 data-[state=on]:bg-blue-500 data-[state=on]:text-white" aria-label="Blue toggle">
				<Star className="h-4 w-4" />
			</Toggle>
			<Toggle
			...
			<Toggle className="bg-red-100 data-[state=on]:bg-red-500 data-[state=on]:text-white" aria-label="Red toggle">
				<Star className="h-4 w-4" />
			</Toggle>
			<Toggle
