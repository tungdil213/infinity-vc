...
import { Popover, PopoverContent, PopoverTrigger } from '@infinity.dev/ui/primitives/popover';
...
import { Settings, Bell, Calendar, CreditCard, Download, Share, User, Mail, MessageSquare } from 'lucide-react';
				...
				<div className="grid gap-4">
					<div className="flex items-center space-x-2">
						...
						<div className="flex-1 space-y-1">
							...
							<p className="text-sm text-muted-foreground">Enable notification alerts.</p>
						</div>
						<Switch />
					</div>
					<div className="flex items-center space-x-2">
						...
						<div className="flex-1 space-y-1">
							...
							<p className="text-sm text-muted-foreground">Show calendar events.</p>
						</div>
						<Switch />
					</div>
					<div className="flex items-center space-x-2">
				...
				<div className="grid gap-4">
					...
					<div className="grid gap-2">
						<div className="grid grid-cols-3 items-center gap-4">
							...
							<Input id="link" value="https://example.com/document" className="col-span-2 h-8" readOnly />
		...
		<Popover>
			<PopoverTrigger asChild>
				<Button variant="noShadow" className="w-8 h-8 rounded-full p-0">
					<img src="https://github.com/shadcn.png" alt="@shadcn" className="rounded-full" />
				</Button>
			</PopoverTrigger>
			<PopoverContent className="w-80">
				<div className="grid gap-4">
					<div className="flex items-center gap-4">
						<img src="https://github.com/shadcn.png" alt="@shadcn" className="rounded-full w-10 h-10" />
