...
import { Tooltip, TooltipContent, TooltipTrigger } from '@infinity.dev/ui/primitives/tooltip';
import { Button } from '@infinity.dev/ui/primitives/button';
import { HelpCircle, Info, Settings, Plus, Trash2, Copy, Share2, Calendar, Bell } from 'lucide-react';
		...
		<div className="flex gap-4">
			{[
				...
				<Tooltip key={item.side}>
					...
					<TooltipContent side={item.side}>{item.label}</TooltipContent>
				</Tooltip>
			))}
		</div>
	),
...
export const WithDelay: Story = {
	render: () => (
		<Tooltip delayDuration={700}>
			...
			<TooltipContent>Tooltip with 700ms delay</TooltipContent>
		</Tooltip>
	),
};
		...
		<Tooltip>
			...
			<TooltipContent side="right" className="w-80 p-0" sideOffset={10}>
				<div className="flex flex-col gap-2 p-4">
					...
					<p className="text-xs text-primary/80">You have 3 unread notifications.</p>
	...
	render: () => (
		<div className="flex gap-4">
			<Tooltip>
				...
				<TooltipContent className="bg-green-500 text-white">Operation successful!</TooltipContent>
			</Tooltip>
			<Tooltip>
				<TooltipTrigger asChild>
					<Button variant="neutral">Error</Button>
				</TooltipTrigger>
				<TooltipContent className="bg-red-500 text-white">Something went wrong</TooltipContent>
			</Tooltip>
			<Tooltip>
				<TooltipTrigger asChild>
