	...
	render: () => (
		<div className="space-y-6">
			<div>
				...
				<p className="text-sm text-muted-foreground">This is the first section of the content.</p>
			</div>
			<Separator />
			<div>
				<h4 className="text-lg font-semibold">Section 2</h4>
				<p className="text-sm text-muted-foreground">This is the second section of the content.</p>
			</div>
			<Separator />
			<div>
				<h4 className="text-lg font-semibold">Section 3</h4>
				<p className="text-sm text-muted-foreground">This is the third section of the content.</p>
			</div>
		</div>
	),
};
