		...
		<Dialog>
			...
			<DialogContent>
				<DialogHeader>
					...
					<DialogDescription>
						A dialog is a window overlaid on either the primary window or another dialog window. Content behind a modal
						dialog is inert, meaning that users cannot interact with it.
					</DialogDescription>
				</DialogHeader>
				<DialogFooter>
		...
		<Dialog>
			...
			<DialogContent>
				...
				<DialogFooter className="sm:justify-start">
					<div className="text-sm text-muted-foreground">Link expires in 24 hours.</div>
				</DialogFooter>
			</DialogContent>
		</Dialog>
	),
				...
				<div className="space-y-4 py-4">
					{[
						...
						<div key={section} className="space-y-2">
							...
							<p className="text-sm text-muted-foreground">
								Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos voluptatum, quae, voluptas, quod
								voluptatibus quas voluptates accusantium quia doloribus quibusdam nemo. Quisquam, quae voluptates.
