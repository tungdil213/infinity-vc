...
import { Settings, User, CreditCard, Plus, X, ShoppingCart, Package, Trash2, Share2, Filter } from 'lucide-react';
		...
		<Drawer direction={direction}>
			...
			<DrawerContent>
				<DrawerHeader>
					...
					<DrawerDescription>Anyone with the link will be able to view this.</DrawerDescription>
				</DrawerHeader>
				<div className="p-4">
					<div className="flex items-center space-x-2">
						<Input readOnly value="https://example.com/shared-page" className="flex-1" />
						<Button>Copy</Button>
					</div>
