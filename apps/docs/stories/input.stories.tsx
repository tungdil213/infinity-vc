...
export const Invalid: Story = {
	render: (args) => <Input {...args} aria-invalid="true" placeholder="Invalid input" />,
};
...
export const WithLabelAndDescription: Story = {
	render: (args) => (
		<div className="space-y-2">
			...
			<Input id="name" {...args} />
			<p className="text-sm text-muted-foreground">This is how your name will appear in your account.</p>
		</div>
	),
	args: {
	...
	render: (args) => (
		<div className="space-y-4">
			<div className="space-y-2">
				...
				<div className="relative">
					<Mail className="absolute left-3 top-2.5 h-4 w-4 text-muted-foreground" />
					<Input id="email-input" {...args} type="email" placeholder="Enter your email" className="pl-10" />
				</div>
			</div>
			<div className="space-y-2">
				...
				<div className="relative">
					...
					<Input id="username-input" {...args} placeholder="Enter your username" className="pl-10" />
				</div>
			</div>
		</div>
	),
