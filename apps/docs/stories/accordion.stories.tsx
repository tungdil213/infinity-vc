...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '@infinity.dev/ui/primitives/accordion';
import { Button } from '@infinity.dev/ui/primitives/button';
import { Badge } from '@infinity.dev/ui/primitives/badge';
import { Settings, User, CreditCard, Bell, Mail, Shield, HelpCircle, Plus } from 'lucide-react';
	...
	render: () => (
		<Accordion type="multiple" className="w-[400px]">
			<AccordionItem value="item-1">
				...
				<AccordionContent>Customize your application settings and preferences.</AccordionContent>
			</AccordionItem>
			<AccordionItem value="item-2">
				<AccordionTrigger>
					<div className="flex items-center gap-2">
				...
				<AccordionContent>Manage your account details and security preferences.</AccordionContent>
			</AccordionItem>
			<AccordionItem value="item-3">
				<AccordionTrigger>
					<div className="flex items-center gap-2">
				...
				<AccordionContent>Configure your notification preferences and alerts.</AccordionContent>
			</AccordionItem>
		</Accordion>
	),
};
	...
	render: () => (
		<Accordion type="single" collapsible className="w-[400px]">
			<AccordionItem value="item-1">
				...
				<AccordionContent>View your unread messages and recent conversations.</AccordionContent>
			</AccordionItem>
			<AccordionItem value="item-2">
				<AccordionTrigger className="flex justify-between">
					<div className="flex items-center gap-2">
				...
				<AccordionContent>Check your latest notifications and updates.</AccordionContent>
			</AccordionItem>
			<AccordionItem value="item-3">
				<AccordionTrigger className="flex justify-between">
					<div className="flex items-center gap-2">
				...
				<AccordionContent>Review your security settings and recent activity.</AccordionContent>
			</AccordionItem>
		</Accordion>
	),
};
...
export const CustomStyles: Story = {
	render: () => (
		<Accordion type="single" collapsible className="w-[400px] rounded-lg border p-6 [&>*]:border-0">
			<AccordionItem value="item-1" className="bg-muted/50 px-4 rounded-md mb-2">
				<AccordionTrigger>Custom Style 1</AccordionTrigger>
				<AccordionContent>This item has a custom background and padding.</AccordionContent>
			</AccordionItem>
			<AccordionItem value="item-2" className="bg-blue-100 dark:bg-blue-900/20 px-4 rounded-md mb-2">
				<AccordionTrigger>Custom Style 2</AccordionTrigger>
				<AccordionContent>This item has a different background color.</AccordionContent>
			</AccordionItem>
			<AccordionItem
				value="item-3"
			...
			>
				...
				<AccordionContent>This item has a gradient background.</AccordionContent>
			</AccordionItem>
		</Accordion>
	),
};
