...
export const WithDescription: Story = {
	render: () => (
		<div className="grid gap-1.5">
			...
			<p className="text-sm text-muted-foreground">Write a short description about yourself.</p>
		</div>
	),
};
...
export const ErrorState: Story = {
	render: () => (
		<div className="grid gap-1.5">
			...
			<Input id="error-input" aria-invalid className="border-destructive focus-visible:ring-destructive/30" />
