...
import { Alert, AlertDescription, AlertTitle } from '@infinity.dev/ui/primitives/alert';
import { Button } from '@infinity.dev/ui/primitives/button';
import { AlertCircle, AlertTriangle, CheckCircle2, Info, Terminal, XCircle } from 'lucide-react';
...
export const Default: Story = {
	render: () => (
		<Alert>
			...
			<AlertDescription>This is a basic alert with default styling.</AlertDescription>
		</Alert>
	),
};
...
export const MultiParagraph: Story = {
	render: () => (
		<Alert>
			...
			<AlertDescription>
				<p>
					We've updated our privacy policy to better protect your personal information and comply with new data
					protection regulations.
				</p>
				<p className="mt-2">
					The changes will take effect on January 1st, 2024. Please review the updated policy to understand how these
					changes affect you.
				</p>
			</AlertDescription>
		</Alert>
