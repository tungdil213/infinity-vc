				...
				<NavigationMenuItem>
					...
					<NavigationMenuContent>
						<ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-2">
							<ListItem href="/analytics" title="Analytics" icon={BarChart}>
								View detailed analytics and reports.
							</ListItem>
							<ListItem href="/users" title="Users" icon={Users}>
								Manage users and permissions.
							</ListItem>
							<ListItem href="/settings" title="Settings" icon={Settings}>
								Configure application settings.
							</ListItem>
							<ListItem href="/help" title="Help" icon={LifeBuoy}>
				...
				<NavigationMenuItem>
					...
					<NavigationMenuContent>
						<ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2">
							...
							<ListItem href="/github" title="GitHub" icon={Github}>
				...
				<NavigationMenuItem>
					...
					<NavigationMenuContent>
						<ul className="grid w-[200px] gap-3 p-4">
							<ListItem href="#" title="Light" icon={Sun} onClick={() => {}}>
								Light theme
							</ListItem>
							<ListItem href="#" title="Dark" icon={Moon} onClick={() => {}}>
								Dark theme
							</ListItem>
							<ListItem href="#" title="System" icon={Laptop} onClick={() => {}}>
								System theme
							</ListItem>
						</ul>
					</NavigationMenuContent>
