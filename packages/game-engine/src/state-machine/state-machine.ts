 ...
 */
export class StateMachine<TContext = unknown, TEvent = unknown> implements IStateMachine<TContext, TEvent> {
	...
	constructor(config: IStateMachineConfig<TContext, TEvent>, initialContext: TContext) {
 ...
 */
export function createStateMachine<TContext = unknown, TEvent = unknown>(): StateMachineBuilder<TContext, TEvent> {
