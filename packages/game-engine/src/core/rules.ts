 ...
 */
export interface IRule<TState extends IGameState = IGameState, TAction extends IAction = IAction> {
	/** Rule identifier */
	readonly id: string;
 ...
 */
export interface IRuleEngine<TState extends IGameState = IGameState, TAction extends IAction = IAction> {
	/**
 ...
 */
export class CompositeRule<TState extends IGameState = IGameState, TAction extends IAction = IAction> extends BaseRule<
	TState,
	TAction
> {
	constructor(
