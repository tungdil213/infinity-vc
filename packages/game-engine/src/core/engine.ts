...
import type { IGameState, IAction, IActionResult, IPlayer, IGameConfig, IPlayerView, IGameMetadata } from './types.js';

/**
 * Game engine interface - the main abstraction for any game
 */
export interface IGameEngine<TState extends IGameState = IGameState, TAction extends IAction = IAction> {
	/**
	 * Get game metadata
	 */
