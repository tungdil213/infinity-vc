...
export interface IEventStore {
	 ...
	 */
	readStream(aggregateId: string, aggregateType: string, options?: ReadOptions): Promise<Result<EventStream, Error>>;
	 ...
	 */
	subscribe(callback: (event: StoredEvent) => Promise<void>, fromPosition?: number): () => void;
}
...
export class InMemorySnapshotStore implements ISnapshotStore {
	...
	async load<TState>(aggregateId: string, aggregateType: string): Promise<Result<Snapshot<TState> | null, Error>> {
