 ...
 */
export abstract class EventHandler<TEvent extends IEvent, TResult = void> implements IEventHandler<TEvent, TResult> {
 ...
 */
export abstract class EventHandlerDecorator<TEvent extends IEvent, TResult = void> implements IEventHandler<
	TEvent,
	TResult
> {
 ...
 */
export class RetryEventHandler<TEvent extends IEvent, TResult = void> extends EventHandlerDecorator<TEvent, TResult> {
	constructor(
